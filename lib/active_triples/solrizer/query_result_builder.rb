module ActiveTriples::Solrizer
  module QueryResultBuilder
    ...
    def self.class_from_solr_document(hit, opts = {})
      ...
      ActiveTriples::Resource.logger.warn "Could not find a model for #{hit["id"]}, defaulting to ActiveTriples::Resource" unless best_model_match if ActiveTriples::Resource.logger
      best_model_match || ActiveTriples::Resource
    end
